...
import wf.bitcoin.javabitcoindrpcclient.model.ExtendedTxInput;
...
public class BitcoinJSONRPCClientTest {
    ...
    public void signRawTransactionTest() throws Exception {
        client = new MyClientTest(false, "signrawtransaction", null,
                                    "{\n" +
                                            ...
                                            "  \"complete\": true\n" +
                                            "}\n");
        LinkedList<ExtendedTxInput> inputList = new LinkedList<ExtendedTxInput>();
        ...
        Assert.assertEquals("",
                    hex);
    }
    ...
    public void signRawTransactionTestException() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals(e.getMessage(), "Incomplete");
        }
    }
